...
RevCore::ECALL_status_t RevCore::ECALL_io_setup(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_destroy(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: io_destroy called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 2, rev_io_submit(aio_context_t, long, struct iocb  *  *)
RevCore::ECALL_status_t RevCore::ECALL_io_submit(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_cancel(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_getevents(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_setxattr(RevInst& inst){
#if 0
...
RevCore::ECALL_status_t RevCore::ECALL_lsetxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fsetxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_lgetxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fgetxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_listxattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_epoll_ctl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_epoll_pwait(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: epoll_pwait called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 23, rev_dup(unsigned int fildes)
RevCore::ECALL_status_t RevCore::ECALL_dup(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_dup3(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fcntl64(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: fcntl64 called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 26, rev_inotify_init1(int flags)
RevCore::ECALL_status_t RevCore::ECALL_inotify_init1(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_inotify_add_watch(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: inotify_add_watch called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 28, rev_inotify_rm_watch(int fd, __s32 wd)
RevCore::ECALL_status_t RevCore::ECALL_inotify_rm_watch(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mknodat(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mkdirat(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_unlinkat(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_statfs64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fallocate(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_faccessat(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: faccessat called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 49, rev_chdir(const char  *filename)
RevCore::ECALL_status_t RevCore::ECALL_chdir(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fchmodat(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_openat(RevInst& inst){
  auto dirfd = RegFile->GetX<int>(10);
...
// TODO: RevCore::ECALL_status_t RevCore::ECALL_openat(RevInst& inst){
...
//   RevCore::ECALL_status_t rtval = ECALL_status_t::SUCCESS;
//   /*
//    * NOTE: this is currently only opening files in the current directory
//    *       because of some oddities in parsing the arguments & flags
//    *       but this will be fixed in the near future
...
//     rtval = RevCore::ECALL_status_t::CONTINUE;
...
//     ECALL.buf[0] = '\0';
//     rtval = RevCore::ECALL_status_t::SUCCESS;
...
RevCore::ECALL_status_t RevCore::ECALL_close(RevInst& inst){
...
// 58, rev_vhangup(void)
RevCore::ECALL_status_t RevCore::ECALL_vhangup(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: vhangup called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 59, rev_pipe2(int  *fildes, int flags)
RevCore::ECALL_status_t RevCore::ECALL_pipe2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_quotactl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getdents64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_lseek(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: lseek called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 63, rev_read(unsigned int fd
RevCore::ECALL_status_t RevCore::ECALL_read(RevInst& inst){
  auto fd = RegFile->GetX<int>(10);
...
RevCore::ECALL_status_t RevCore::ECALL_write(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_readv(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_writev(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pread64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pwrite64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_preadv(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pwritev(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sendfile64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pselect6_time32(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_ppoll_time32(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_signalfd4(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_vmsplice(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_splice(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_tee(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_readlinkat(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sync_file_range2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sync_file_range(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: sync_file_range called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 85, rev_timerfd_create(int clockid, int flags)
RevCore::ECALL_status_t RevCore::ECALL_timerfd_create(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_timerfd_settime(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_timerfd_gettime(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_utimensat(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: utimensat called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 89, rev_acct(const char  *name)
RevCore::ECALL_status_t RevCore::ECALL_acct(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_capget(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_capset(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: capset called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 92, rev_personality(unsigned int personality)
RevCore::ECALL_status_t RevCore::ECALL_personality(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_exit(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_exit_group(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_futex(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_set_robust_list(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_get_robust_list(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_nanosleep(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getitimer(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_setitimer(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_kexec_load(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_init_module(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_delete_module(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_timer_create(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_timer_gettime(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: timer_gettime called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 109, rev_timer_getoverrun(timer_t timer_id)
RevCore::ECALL_status_t RevCore::ECALL_timer_getoverrun(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_timer_settime(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: timer_settime called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 111, rev_timer_delete(timer_t timer_id)
RevCore::ECALL_status_t RevCore::ECALL_timer_delete(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_clock_settime(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_clock_gettime(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_clock_getres(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_clock_nanosleep(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: clock_nanosleep called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 116, rev_syslog(int type, char  *buf, int len)
RevCore::ECALL_status_t RevCore::ECALL_syslog(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_ptrace(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_setparam(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_setscheduler(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: sched_setscheduler called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 120, rev_sched_getscheduler(pid_t pid)
RevCore::ECALL_status_t RevCore::ECALL_sched_getscheduler(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_getparam(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_setaffinity(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_get_priority_min(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sigaltstack(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigsuspend(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigaction(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigprocmask(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigpending(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigtimedwait_time32(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rt_sigqueueinfo(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_setpriority(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: setpriority called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 141, rev_getpriority(int which, int who)
RevCore::ECALL_status_t RevCore::ECALL_getpriority(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getrlimit(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_prctl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getcpu(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_gettimeofday(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sysinfo(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mq_open(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: mq_open called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 181, rev_mq_unlink(const char  *name)
RevCore::ECALL_status_t RevCore::ECALL_mq_unlink(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mq_timedsend(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mq_timedreceive(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mq_notify(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mq_getsetattr(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: mq_getsetattr called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 186, rev_msgget(key_t key, int msgflg)
RevCore::ECALL_status_t RevCore::ECALL_msgget(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_msgctl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_msgrcv(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_msgsnd(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: msgsnd called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 190, rev_semget(key_t key, int nsems, int semflg)
RevCore::ECALL_status_t RevCore::ECALL_semget(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_semctl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_semtimedop(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_semop(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: semop called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 194, rev_shmget(key_t key, size_t size, int flag)
RevCore::ECALL_status_t RevCore::ECALL_shmget(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sendto(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_recvfrom(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_setsockopt(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getsockopt(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: getsockopt called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 210, rev_shutdown(int, int)
RevCore::ECALL_status_t RevCore::ECALL_shutdown(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sendmsg(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_munmap(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mremap(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_add_key(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_request_key(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_keyctl(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_clone(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_execve(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: execve called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 222, rev_old_mmap(struct mmap_arg_struct  *arg)
RevCore::ECALL_status_t RevCore::ECALL_mmap(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fadvise64_64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_swapon(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: swapon called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 225, rev_swapoff(const char  *specialfile)
RevCore::ECALL_status_t RevCore::ECALL_swapoff(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mprotect(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mincore(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_madvise(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_remap_file_pages(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mbind(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_get_mempolicy(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_set_mempolicy(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_migrate_pages(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_move_pages(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_recvmmsg_time32(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_wait4(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_prlimit64(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fanotify_init(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fanotify_mark(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_name_to_handle_at(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_open_by_handle_at(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sendmmsg(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_process_vm_readv(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_process_vm_writev(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_setattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_sched_getattr(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_renameat2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_seccomp(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_getrandom(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_memfd_create(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_bpf(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_execveat(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: execveat called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 282, rev_userfaultfd(int flags)
RevCore::ECALL_status_t RevCore::ECALL_userfaultfd(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_membarrier(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_mlock2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_copy_file_range(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_preadv2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pwritev2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pkey_mprotect(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pkey_alloc(RevInst& inst){
  output->verbose(CALL_INFO, 2, 0, "ECALL: pkey_alloc called by thread %" PRIu32 "\n", GetActiveThreadID());
  return ECALL_status_t::SUCCESS;
}

// 290, rev_pkey_free(int pkey)
RevCore::ECALL_status_t RevCore::ECALL_pkey_free(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_statx(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_pgetevents(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_rseq(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_kexec_file_load(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pidfd_send_signal(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_uring_setup(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_uring_enter(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_io_uring_register(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_open_tree(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_move_mount(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fsopen(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fsconfig(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_fsmount(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_close_range(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_openat2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pidfd_getfd(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_faccessat2(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_process_madvise(RevInst& inst){
...
//                          void *restrict arg);
RevCore::ECALL_status_t RevCore::ECALL_pthread_create(RevInst& inst){
...
RevCore::ECALL_status_t RevCore::ECALL_pthread_join(RevInst& inst){
  RevCore::ECALL_status_t rtval = RevCore::ECALL_status_t::CONTINUE;
